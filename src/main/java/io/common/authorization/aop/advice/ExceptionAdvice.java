package io.common.authorization.aop.advice;

import io.common.authorization.error.ErrorDTO;
...
public class ExceptionAdvice {
    ...
    public ResponseEntity<ErrorDTO> dkargoException(ErrorException e) {
